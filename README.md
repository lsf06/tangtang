...
[简介](#-项目简介) • [功能特性](#-功能特性) • [系统架构](#-系统架构) • [硬件选型](#-硬件选型) • [产品展示](#-产品展示) • [快速开始](#-快速开始) • [API 文档](#-api 文档) • [FAQ](#-常见问题) • [贡献指南](#-贡献指南) • [版本历史](#-版本历史)
...
> ⚠️ **注**：以下为 AI 生成的概念设计图，用于展示产品外观设计方案。实物照片待硬件组装完成后补充。
