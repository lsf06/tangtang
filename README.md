...
本项目包含以下详细文档，帮助你深入了解和使用：

| 文档 | 说明 |
|------|------|
| [📐 架构文档](docs/ARCHITECTURE.md) | 系统架构、组件设计、数据流说明 |
| [🤖 模型信息卡](docs/MODEL_CARD.md) | AI 模型规格、输入输出格式、性能指标 |
| [🛒 硬件采购指南](docs/HARDWARE_BUYING_GUIDE.md) | 硬件清单、供应商信息、采购建议 |
| [🗺️ 项目路线图](docs/ROADMAP.md) | 版本规划、里程碑、开发计划 |
| [💻 开发文档](docs/DEVELOPMENT.md) | 开发环境设置、调试指南、代码规范 |
| [🙏 贡献指南](CONTRIBUTING.md) | 如何贡献代码、提交规范、行为准则 |
| [📄 变更日志](CHANGELOG.md) | 版本更新记录、新增功能、Bug 修复 |
| [🔒 安全策略](SECURITY.md) | 安全漏洞报告流程、加密措施 |
